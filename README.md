...
~~~~~ mjs
import { Ipp5BackendApiLauncher } from 'e53e04ac/ipp5-backend-api-launcher';
~~~~~
...
graph RL;
  ...
  click B_6 "https://github.com/e53e04ac/ipp5-types/tree/e950b5bccb9901b27ada132a459c0117aa587939";
~~~~~

~~~~~ mermaid
graph RL;
  subgraph "e53e04ac/ipp5-backend-api-launcher";
    E_0(["Ipp5BackendApiLauncher"]);
  end;
  M(["index.mjs"])
...
graph RL;
  subgraph "e53e04ac/ipp5-backend-api-launcher";
    E_0(["type Ipp5BackendApiLauncher"]);
    E_1(["const Ipp5BackendApiLauncher"]);
  end;
  M(["index.d.ts"])
  subgraph "azure-terraformer";
    I_0_0(["AzureTerraformer"]);
